...
urlpatterns = [
    ...
    path("game_info", views.GameInfoView.as_view()),
    path("game_info/<int:pk>/", views.GameInfoView.as_view()),
    ...
    path("about-cybercarnage/", views.about_list_view, name="about_list"),
    path("in-game-info/", views.in_game_info_list_view, name="in_game_info"),
    ...
    path(
        "game-detail/<int:pk>/<slug:slug>/", views.game_detail_view, name="game_detail"
    ),
]
