...
#           <h2 style="font-family:'Orbitron',sans-serif;font-size:27px;
#                      color:#bc13fe;margin:0 0 10px 0;letter-spacing:1px;">
#             {instance.game_name}
#           </h2>
#
...
#             <a href="https://cyber-carnage.vercel.app/game_detail/{instance.pk}/{instance.slug}/"
